...
<main class="h-full pb-16 overflow-y-auto">
          ...
          <form action="{{ URL::to('news/' . $data->id) }}" method="post" enctype="multipart/form-data">
         @method('put')
          {{ csrf_field() }}
            <div
            ...
            >
              ...
              <label class="block mt-4 text-sm">
                ...
                <select
                 name="type" selected="{{$data->type}}" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                >
              ...
              <label class="block mt-6 text-sm">
                ...
                <div class="flex flex-col items-center ">
                   <input type="date" name="date" value="{{$data->date}}" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"> </div>
              </label>
              <label class="block mt-6 text-sm">
                ...
                <div class="flex flex-col items-center ">
                   ...
                   <img src="{{ URL::to('/') }}/assets/img/news/{{ $data->image }}" class="img-thumbnail" width="100" />
              ...
              <label class="block mt-6 text-sm">
                ...
                <div class="flex flex-col items-center ">
                   <input type="file" name="image_two" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"> </div>
                   <img src="{{ URL::to('/') }}/assets/img/news/{{ $data->image_two }}" class="img-thumbnail" width="100" />
