          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <h6>Thinley Dorji</h6>
                <h2>I'm <em>Web Designer</em> &amp; <span>Web Developer</span></h2>
                <p>if you are looking for developing a beautiful website with powerfull PHP framework Laravel hire me <a rel="nofollow" href="" target="_parent">Mail Me</a>.</p>
              ...
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                  ...
                  <div class="right-text">
                    ...
                    <p>We develop beautiful websites using php frameworks</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.7s">
                  ...
                  <div class="right-text">
                    <h4>Designing</h4>
                    <p>We Design both web & application using AdobeXD</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              ...
              <div class="showed-content">
                <img src="{{URL::to('/')}}/assets/img/project/{{$project->image}}" alt="">
              </div>
            </div>
          </a>
        </div>
			...
			@foreach($news as $new)
              <li>
                ...
                <div class="right-image">
                  <a href="#"><img src="{{URL::to('/')}}/assets/img/news/{{$new->image}}" alt=""></a>
                </div>
              </li>
			  @endforeach
            </ul>
